    ...
    return (
        <Container>
            <Stack
                ...
                <AppBar>
                    <Toolbar>
                        <Typography variant={'h5'}>Kebijakan Privasi</Typography>
                    </Toolbar>
                </AppBar>
                <Toolbar />
                <Toolbar />
                ...
                <Typography variant={'body1'}
                    ...
                    <br />
                    Hukum Perlindungan Data Umum Brasil
                    Anda dapat mempelajari lebih lanjut tentang hak Anda, termasuk cara menggunakan hak Anda berdasarkan Undang-Undang Perlindungan Data Umum Brasil
                </Typography>
                <Typography variant={'h5'}>
                    Hubungi Kami
                </Typography>
